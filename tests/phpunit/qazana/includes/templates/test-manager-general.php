...
class Qazana_Test_Manager_General extends Qazana_Test_Base {
	/**
	 * @var Manager
	 */
	...
	public function test_should_return_import_images_instance() {
		$this->assertEquals( self::$manager->get_import_images_instance(), new \Qazana\Template_Library\Classes\Import_Images() );
	}
	...
	public function test_should_return_wp_error_wrong_instance_source_from_register_source() {
		$this->assertWPError( self::$manager->register_source( 'Qazana\Core\Ajax_Manager' ), 'wrong_instance_source' );
	}
