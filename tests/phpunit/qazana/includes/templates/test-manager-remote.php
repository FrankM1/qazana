...
class Qazana_Test_Manager_Remote extends Qazana_Test_Base {

	/**
	 * @var \Qazana\Template_Library\Manager
	 */
	...
	public function test_should_return_true_from_register_source() {
		$this->assertTrue( self::$manager->register_source( 'Qazana\Template_Library\Source_Remote' ) );
	}

	public function test_should_return_registered_sources() {
		$this->assertEquals( self::$manager->get_registered_sources()['remote'], new \Qazana\Template_Library\Source_Remote() );
	}

	public function test_should_return_source() {
		$this->assertEquals( self::$manager->get_source( 'remote' ), new \Qazana\Template_Library\Source_Remote() );
	}
