...
var ControlBaseView = __webpack_require__(140),
    TagsBehavior = __webpack_require__(295),
...
var _Object$getPrototypeOf = __webpack_require__(171);

var _Object$setPrototypeOf = __webpack_require__(170);
...
var _Object$create = __webpack_require__(94);

var setPrototypeOf = __webpack_require__(219);
    ...
    if (options.removeDefault) {
      ...
      _.each(data, function (value, key) {
        ...
        if (control) {
          ...
          if (data[key] && 'object' === (0, _typeof2.default)(data[key])) {
            // First check length difference
            if ((0, _keys.default)(data[key]).length !== (0, _keys.default)(control.default).length) {
              return;
...
var ControlBaseDataView = __webpack_require__(41),
...
var TemplateLibraryHeaderView = __webpack_require__(154),
    TemplateLibraryHeaderLogoView = __webpack_require__(143),
    TemplateLibraryLoadingView = __webpack_require__(155);
...
var _isArray = _interopRequireDefault(__webpack_require__(275));
...
var BaseSettingsModel = __webpack_require__(105),
    ControlsCSSParser = __webpack_require__(153),
    Validator = __webpack_require__(162),
    BaseContainer = __webpack_require__(185),
    BaseElementView;
...
BaseElementView = BaseContainer.extend({
  ...
  getChildView: function getChildView(model) {
    ...
    if ('section' === elType) {
      ChildView = __webpack_require__(186);
    } else if ('column' === elType) {
      ChildView = __webpack_require__(288);
    } else {
  ...
  pasteStyle: function pasteStyle() {
    ...
    jQuery.each(controls, function (controlName, control) {
      ...
      if ('object' === (0, _typeof2.default)(sourceValue)) {
        if ('object' !== (0, _typeof2.default)(targetValue)) {
          return;
        }
...
ControlsStack = Marionette.CompositeView.extend({
  ...
  behaviors: {
    HandleInnerTabs: {
      behaviorClass: __webpack_require__(190)
    }
  },
  initialize: function initialize() {
    this.initCollection();
...
var dP = __webpack_require__(23).f;
var gOPN = __webpack_require__(176).f;
var isRegExp = __webpack_require__(103);
var $flags = __webpack_require__(82);
...
if (__webpack_require__(7) && (!CORRECT_NEW || __webpack_require__(10)(function () {
...
var ViewModule = __webpack_require__(40),
    Stylesheet = __webpack_require__(180),
    ControlsCSSParser;
  ...
  getDefaultElements: function getDefaultElements() {
    return {
      $stylesheetElement: jQuery('<style>', {
        id: 'qazana-style-' + this.getSettings('id')
      })
    };
  },
  ...
  _.each(control.selectors, function (cssProperty, selector) {
    ...
    try {
      outputCssProperty = cssProperty.replace(/{{(?:([^.}]+)\.)?([^}]*)}}/g, function (originalPhrase, controlName, placeholder) {
        ...
        if (controlName) {
          parserControl = _.findWhere(controls, {
            name: controlName
          });
...
var ViewModule = __webpack_require__(40),
    SettingsModel = __webpack_require__(105),
    ControlsCSSParser = __webpack_require__(153);
...
var isObject = __webpack_require__(6);
var setPrototypeOf = __webpack_require__(234).set;
...
var TemplateLibraryInsertTemplateBehavior = __webpack_require__(181),
...
var $export = __webpack_require__(35);
var $find = __webpack_require__(83)(6);
var KEY = 'findIndex';
var forced = true;
// Shouldn't skip holes
if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
var _inline = _interopRequireDefault(__webpack_require__(279));

var BaseElementView = __webpack_require__(144),
    SectionView;
...
var _construct = _interopRequireDefault(__webpack_require__(99));

var _classCallCheck2 = _interopRequireDefault(__webpack_require__(92));

var _createClass2 = _interopRequireDefault(__webpack_require__(93));

var _inherits2 = _interopRequireDefault(__webpack_require__(100));

var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(101));

var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(96));
...
var ControlMultipleBaseItemView = __webpack_require__(136),
...
var ControlBaseMultipleItemView = __webpack_require__(136),
...
var BaseSettingsModel = __webpack_require__(105),
    ColumnSettingsModel = __webpack_require__(330),
    ElementModel;
...
ElementModel = Backbone.Model.extend({
  ...
  initialize: function initialize(options) {
    ...
    if (undefined !== elements) {
      var ElementsCollection = __webpack_require__(196);
...
var ElementModel = __webpack_require__(195);
...
var anObject = __webpack_require__(8);
var sameValue = __webpack_require__(333);
var regExpExec = __webpack_require__(63);
...
var PanelElementsElementModel = __webpack_require__(200),
...
var PanelSchemeBaseView = __webpack_require__(203),
...
var childViewTypes = {
  color: __webpack_require__(363),
  typography: __webpack_require__(364)
},
    PanelSchemeBaseView;
...
var _stringify = _interopRequireDefault(__webpack_require__(108));
...
var _heartbeat = _interopRequireDefault(__webpack_require__(210));

var _navigator = _interopRequireDefault(__webpack_require__(213));
...
var App = Marionette.Application.extend({
  ...
  helpers: __webpack_require__(232),
  imagesManager: __webpack_require__(243),
  debug: __webpack_require__(244),
  schemes: __webpack_require__(245),
  presetsFactory: __webpack_require__(246),
  templates: __webpack_require__(247),
  ajax: __webpack_require__(262),
  conditions: __webpack_require__(263),
  hotKeys: __webpack_require__(161),
  history: __webpack_require__(264),
  channels: {
  ...
  modules: {
    Module: __webpack_require__(46),
    components: {
      templateLibrary: {
        views: {
          parts: {
            headerParts: {
              logo: __webpack_require__(143)
            }
          },
          BaseModalLayout: __webpack_require__(142)
        }
      },
      saver: {
        behaviors: {
          HeaderSaver: __webpack_require__(294),
          FooterSaver: __webpack_require__(188)
        }
      }
    },
    controls: {
      Animation: __webpack_require__(139),
      Base: __webpack_require__(140),
      BaseData: __webpack_require__(41),
      BaseMultiple: __webpack_require__(136),
      Box_shadow: __webpack_require__(191),
      Button: __webpack_require__(303),
      Choose: __webpack_require__(192),
      Code: __webpack_require__(304),
      Color: __webpack_require__(305),
      Date_time: __webpack_require__(306),
      Dimensions: __webpack_require__(307),
      Font: __webpack_require__(310),
      Gallery: __webpack_require__(311),
      Hover_animation: __webpack_require__(139),
      Icon: __webpack_require__(312),
      Image_dimensions: __webpack_require__(313),
      Media: __webpack_require__(314),
      Number: __webpack_require__(315),
      Order: __webpack_require__(317),
      Query: __webpack_require__(318),
      Popover_toggle: __webpack_require__(319),
      Repeater: __webpack_require__(320),
      RepeaterRow: __webpack_require__(194),
      Section: __webpack_require__(321),
      Select: __webpack_require__(322),
      Select2: __webpack_require__(139),
      Slider: __webpack_require__(323),
      Structure: __webpack_require__(324),
      Switcher: __webpack_require__(325),
      Tab: __webpack_require__(326),
      Text_shadow: __webpack_require__(191),
      Url: __webpack_require__(327),
      Wp_widget: __webpack_require__(328),
      Wysiwyg: __webpack_require__(329)
    },
    elements: {
      models: {
        BaseSettings: __webpack_require__(105),
        Element: __webpack_require__(195)
      },
      views: {
        Widget: __webpack_require__(331)
      }
    },
    layouts: {
      panel: {
        pages: {
          elements: {
            views: {
              ...
              Elements: __webpack_require__(334)
            }
          },
          menu: {
            Menu: __webpack_require__(335)
          }
        }
      }
    },
    views: {
      ControlsStack: __webpack_require__(146)
    }
  },
  ...
  initComponents: function initComponents() {
    var EventManager = __webpack_require__(166),
        DynamicTags = __webpack_require__(338),
        Settings = __webpack_require__(340),
        Saver = __webpack_require__(344),
        Notifications = __webpack_require__(345),
        DocumentConditions = __webpack_require__(346);
  ...
  initElements: function initElements() {
    var ElementCollection = __webpack_require__(196),
  ...
  initPreview: function initPreview() {
    ...
    var previewIframeId = 'qazana-preview-iframe'; // Make sure the iFrame does not exist.
  ...
  setStorage: function setStorage(key, value) {
    ...
    localStorage.setItem('qazana', (0, _stringify.default)(qazanaStorage));
  },
  ...
  onPreviewLoaded: function onPreviewLoaded() {
    ...
    var Preview = __webpack_require__(370);
...
var _layout = _interopRequireDefault(__webpack_require__(225));

function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = (0, _construct.default)(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }

function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !_construct.default) return false; if (_construct.default.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call((0, _construct.default)(Date, [], function () {})); return true; } catch (e) { return false; } }

var BaseRegion = __webpack_require__(173);
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(7) && /./g.flags != 'g') __webpack_require__(23).f(RegExp.prototype, 'flags', {
  configurable: true,
...
module.exports = __webpack_require__(3).Reflect.construct;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(98)(Function.call, __webpack_require__(86).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _element = _interopRequireDefault(__webpack_require__(226));
...
var _values = _interopRequireDefault(__webpack_require__(172));
...
var _elementEmpty = _interopRequireDefault(__webpack_require__(230));

var _rootEmpty = _interopRequireDefault(__webpack_require__(231));
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function onMouseEnter(event) {
      ...
      this.autoExpandTimeout = setTimeout(function () {
        _this2.toggleList(true, function () {
          _this2.ui.elements.sortable('refreshPositions');
        });
      }, 500);
    }
  }, {
...
var $export = __webpack_require__(14);
var $values = __webpack_require__(229)(false);
...
var fails = __webpack_require__(10);
var gOPN = __webpack_require__(176).f;
var gOPD = __webpack_require__(175).f;
var dP = __webpack_require__(23).f;
...
var BROKEN_COF = cof(__webpack_require__(178)(proto)) == NUMBER;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(37)(Function.call, __webpack_require__(175).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
ImagesManager = function ImagesManager() {
  ...
  self.getRemoteItems = function () {
    ...
    if (0 === registeredItemsLength) {
      ...
      image = registeredItems[(0, _keys.default)(registeredItems)[0]];
...
var _getPrototypeOf = _interopRequireDefault(__webpack_require__(171));

var _create = _interopRequireDefault(__webpack_require__(94));

var _stringify = _interopRequireDefault(__webpack_require__(108));

var TemplateLibraryLayoutView = __webpack_require__(248),
    TemplateLibraryCollection = __webpack_require__(260),
...
var BaseModalLayout = __webpack_require__(142),
    TemplateLibraryHeaderActionsView = __webpack_require__(249),
    TemplateLibraryHeaderMenuView = __webpack_require__(250),
    TemplateLibraryHeaderPreviewView = __webpack_require__(251),
    TemplateLibraryHeaderBackView = __webpack_require__(252),
    TemplateLibraryCollectionView = __webpack_require__(253),
    TemplateLibrarySaveTemplateView = __webpack_require__(257),
    TemplateLibraryImportView = __webpack_require__(258),
    TemplateLibraryPreviewView = __webpack_require__(259);
...
var TemplateLibraryTemplateLocalView = __webpack_require__(254),
    TemplateLibraryTemplateRemoteView = __webpack_require__(255),
...
var TemplateLibraryTemplateView = __webpack_require__(182),
...
var TemplateLibraryTemplateModel = __webpack_require__(261),
...
var HistoryPageView = __webpack_require__(265),
    Manager;
...
Manager = function Manager() {
  ...
  var init = function init() {
    ...
    self.history = __webpack_require__(271);
    self.revisions = __webpack_require__(291);
    self.revisions.init();
  };
...
var TabHistoryView = __webpack_require__(266),
    TabHistoryEmpty = __webpack_require__(267),
    TabRevisionsView = __webpack_require__(268),
    TabRevisionsEmpty = __webpack_require__(270);
...
module.exports = Marionette.CompositeView.extend({
  ...
  childView: __webpack_require__(269),
...
var HistoryCollection = __webpack_require__(272),
    HistoryItem = __webpack_require__(184),
    ElementHistoryBehavior = __webpack_require__(273),
    CollectionHistoryBehavior = __webpack_require__(274);
...
var ItemModel = __webpack_require__(184);
...
module.exports = Marionette.Behavior.extend({
  ...
  saveCollectionHistory: function saveCollectionHistory(collection, event) {
    ...
    var title = qazana.history.history.getModelLabel(firstModel); // If it's an unknown model - don't save
  ...
  restore: function restore(historyItem, isRedo) {
    ...
    var BaseElementView = __webpack_require__(144); // Find the new behavior and work with him.
...
module.exports = __webpack_require__(3).Array.isArray;
...
var _get2 = _interopRequireDefault(__webpack_require__(280));
...
var _base = _interopRequireDefault(__webpack_require__(187));
...
var AddSectionView = /*#__PURE__*/function (_BaseAddSectionView) {
  ...
  (0, _createClass2.default)(AddSectionView, [{
    key: "className",
    value: function className() {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(AddSectionView.prototype), "className", this).call(this) + ' qazana-add-section-inline';
    }
  }, {
    key: "fadeToDeath",
...
var _Object$getOwnPropertyDescriptor = __webpack_require__(281);

var _Reflect$get = __webpack_require__(284);

var superPropBase = __webpack_require__(287);
...
module.exports = __webpack_require__(3).Reflect.get;
...
var BaseElementView = __webpack_require__(144),
    ColumnEmptyView = __webpack_require__(289),
    ColumnView;
...
ColumnView = BaseElementView.extend({
  ...
  behaviors: function behaviors() {
    ...
    _.extend(behaviors, {
      ...
      Resizable: {
        behaviorClass: __webpack_require__(290)
      }
    });
...
var RevisionsCollection = __webpack_require__(292),
    RevisionsManager;
...
RevisionsManager = function RevisionsManager() {
  ...
  this.setEditorData = function (data) {
    var collection = qazana.getRegion('sections').currentView.collection; // Don't track in history.
...
var RevisionModel = __webpack_require__(293);
...
var FooterSaver = __webpack_require__(188);
...
var TagPanelView = __webpack_require__(296);
...
module.exports = Marionette.Behavior.extend({
  ...
  createTagsList: function createTagsList() {
    var tags = _.groupBy(this.getOption('tags'), 'group'),
      ...
      class: 'qazana-tags-list'
    }),
        $tagsListInner = jQuery('<div>', {
      class: 'qazana-tags-list__inner'
    });
    ...
    jQuery.each(groups, function (groupName) {
      ...
      var group = this,
        ...
        class: 'qazana-tags-list__group-title'
      }).text(group.title);
      $tagsListInner.append($groupTitle);
      groupTags.forEach(function (tag) {
        var $tag = jQuery('<div>', {
          class: 'qazana-tags-list__item'
        });
...
var TagControlsStack = __webpack_require__(297),
    SettingsModel = __webpack_require__(105);
...
var ControlsStack = __webpack_require__(146),
    EmptyView = __webpack_require__(302);
...
var hide = __webpack_require__(11);
var Iterators = __webpack_require__(165);
var $iterCreate = __webpack_require__(300);
...
var ControlBaseUnitsItemView = __webpack_require__(193),
...
var ControlSelect2View = __webpack_require__(139);
...
ControlMediaItemView = ControlBaseDataView.extend({
  ...
  applySavedValue: function applySavedValue() {
    ...
    thumbnailImages = this.generateThumbnails(images); // There is a bug here whereby first load doesn't generate thumbs
    ...
    thumbnailImages.forEach(function (image) {
      var $thumbnail = jQuery('<div>', {
        class: 'qazana-control-gallery-thumbnail'
      });
...
ControlMediaItemView = ControlMultipleBaseItemView.extend({
  ...
  applySavedValue: function applySavedValue() {
    ...
    if ('image' === mediaType) {
      ...
      var imageUrl = qazana.imagesManager.getImageUrl(thumbnailImage); // There is a bug here whereby first load doesn't generate thumbs
...
var ControlBaseDataView = __webpack_require__(41),
    NumberValidator = __webpack_require__(316),
...
var ControlSelect2ItemView = __webpack_require__(139);
...
module.exports = ControlSelect2ItemView.extend({
  ...
  getValueTitles: function getValueTitles() {
    ...
    var request = qazana.ajax.send('panel_posts_control_value_titles', {
      data: data
    });
...
var ControlChooseView = __webpack_require__(192),
...
var ControlBaseDataView = __webpack_require__(41),
    RepeaterRowView = __webpack_require__(194),
    BaseSettingsModel = __webpack_require__(105),
...
ControlRepeaterItemView = ControlBaseDataView.extend({
  ...
  onRender: function onRender() {
    ...
    this.ui.fieldContainer.sortable({
      axis: 'y',
      handle: '.qazana-repeater-row-tools'
    });
...
var BaseMultiple = __webpack_require__(136);
...
ControlWysiwygItemView = ControlBaseDataView.extend({
  ...
  initialize: function initialize() {
    ControlBaseDataView.prototype.initialize.apply(this, arguments);
    var self = this;
    self.editorID = 'qazanawpeditor' + self.cid; // Wait a cycle before initializing the editors.
...
WidgetView = BaseElementView.extend({
  ...
  behaviors: function behaviors() {
    ...
    _.extend(behaviors, {
      InlineEditing: {
        behaviorClass: __webpack_require__(332),
  ...
  onRender: function onRender() {
    ...
    self.$el.attr('data-element_type', editModel.get('widgetType') + '.' + skinType).removeClass('qazana-widget-empty').children('.qazana-widget-empty-icon').remove(); // TODO: Find better way to detect if all images are loaded
...
PanelElementsElementsView = Marionette.CollectionView.extend({
  childView: __webpack_require__(199),
...
var PanelMenuGroupView = __webpack_require__(336),
    PanelMenuPageView;
...
var PanelMenuItemView = __webpack_require__(337);
...
module.exports = Module.extend({
  modules: {
    base: __webpack_require__(167),
    general: __webpack_require__(341),
    page: __webpack_require__(342)
  },
  panelPages: {
    base: __webpack_require__(343)
  },
  onInit: function onInit() {
    this.initSettings();
  },
...
var BaseSettings = __webpack_require__(167);
...
module.exports = Module.extend({
  ...
  doAutoSave: function doAutoSave() {
    var editorMode = qazana.channels.dataEditMode.request('activeMode'); // Avoid auto save for Revisions Preview changes.
  ...
  saveEditor: function saveEditor(options) {
    ...
    var self = this,
        elements = qazana.elements.toJSON({
      removeDefault: true
    }),
        settings = qazana.settings.page.model.toJSON({
      removeDefault: true
    }),
...
module.exports = Module.extend({
  onInit: function onInit() {
    ...
    if (this.hasDocumentConditions()) {
      ...
      qazana.addControlView('Conditions_repeater', __webpack_require__(347));
  ...
  addHeaderSaver: function addHeaderSaver(behavior) {
    behavior.saver = {
      behaviorClass: __webpack_require__(349)
    };
    return behavior;
  },
  addFooterSaver: function addFooterSaver(behavior) {
    behavior.saver = {
      behaviorClass: __webpack_require__(350)
    };
    return behavior;
  },
  ...
  onQazanaPreviewLoaded: function onQazanaPreviewLoaded() {
    ...
    qazana.settings.page.model.on('change', this.onPageSettingsChange.bind(this));
    qazana.channels.editor.on('qazanaDocumentConditions:ApplyPreview', this.onApplyPreview.bind(this)); // Scroll to Editor. Timeout according to preview resize css animation duration.
...
var RepeaterRowView = __webpack_require__(348);
...
var inlineControlsStack = __webpack_require__(353);
...
module.exports = inlineControlsStack.extend({
  ...
  onClickPublish: function onClickPublish(event) {
    ...
    event.stopPropagation();
    $button.attr('disabled', true).addClass('qazana-button-state'); // Publish.
...
var PanelLayoutView = __webpack_require__(355);
...
module.exports = BaseRegion.extend({
  ...
  beforeFirstOpen: function beforeFirstOpen() {
  ...
  getDraggableOptions: function getDraggableOptions() {
    return {
      iframeFix: true,
  ...
  getResizableOptions: function getResizableOptions() {
    var _this = this;
  ...
  setDockedSize: function setDockedSize() {
    this.$el.css('width', this.storage.size.width);
  },
  ...
  ensurePosition: function ensurePosition() {
    if (this.isDocked) {
      return;
    }
  ...
  onDrag: function onDrag(_event, ui) {
    if (this.isDocked) {
      if (ui.position.left === ui.originalPosition.left) {
        if (ui.position.top !== ui.originalPosition.top) {
          return false;
  ...
  onDragStop: function onDragStop(_event, ui) {
    if (this.isDocked) {
      return;
    }
...
var EditModeItemView = __webpack_require__(356),
    PanelLayoutView;
...
PanelLayoutView = Marionette.LayoutView.extend({
  ...
  buildPages: function buildPages() {
    var pages = {
      elements: {
        view: __webpack_require__(357),
        title: qazana.config.document.title
      },
      editor: {
        view: __webpack_require__(362)
      },
      menu: {
      ...
      colorScheme: {
        view: __webpack_require__(202)
      },
      typographyScheme: {
        view: __webpack_require__(365)
      },
      colorPickerScheme: {
        view: __webpack_require__(366)
      }
    };

    var schemesTypes = (0, _keys.default)(qazana.schemes.getSchemes()),
    ...
    _.each(disabledSchemes, function (schemeType) {
      ...
      pages[schemeType + 'Scheme'].view = __webpack_require__(367).extend({
  ...
  openEditor: function openEditor(model, view) {
    ...
    qazana.hooks.doAction(action, this, model, view); // Example: panel/open_editor/widget/heading

    qazana.hooks.doAction(action + '/' + model.get('widgetType'), this, model, view);
  },
  onBeforeShow: function onBeforeShow() {
    var PanelFooterItemView = __webpack_require__(368),
        PanelHeaderItemView = __webpack_require__(369); // Edit Mode
...
var PanelElementsCategoriesCollection = __webpack_require__(358),
    PanelElementsElementsCollection = __webpack_require__(201),
    PanelElementsCategoriesView = __webpack_require__(359),
    PanelElementsElementsView = qazana.modules.layouts.panel.pages.elements.views.Elements,
    PanelElementsSearchView = __webpack_require__(361),
    PanelElementsGlobalView = __webpack_require__(197),
...
var PanelElementsCategory = __webpack_require__(200),
...
var PanelElementsCategoryView = __webpack_require__(360),
...
var PanelElementsElementsCollection = __webpack_require__(201),
...
var PanelSchemeItemView = __webpack_require__(204),
...
var PanelSchemeColorsView = __webpack_require__(202),
...
module.exports = Marionette.ItemView.extend({
  ...
  ui: {
    buttonSave: '#qazana-panel-footer-saver-button-publish, #qazana-panel-footer-saver-menu-save-draft',
    // TODO: remove. Compatibility for Pro <= 1.9.5
...
var _independent = _interopRequireDefault(__webpack_require__(371));

var BaseSectionsContainerView = __webpack_require__(372),
    Preview;
...
var SectionView = __webpack_require__(186),
    BaseContainer = __webpack_require__(185),
