...
/***/ "../assets/dev/js/editor/components/document-conditions/behavior/footer-saver.js":
/*!***************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/behavior/footer-saver.js ***!
  \***************************************************************************************/
...
/***/ "../assets/dev/js/editor/components/document-conditions/behavior/header-saver.js":
/*!***************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/behavior/header-saver.js ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "../assets/dev/js/editor/components/document-conditions/conditions/repeater-control.js":
/*!*********************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/conditions/repeater-control.js ***!
  \*********************************************************************************************/
/*! no static exports found */
...
var RepeaterRowView = __webpack_require__(/*! ./repeater-row */ "../assets/dev/js/editor/components/document-conditions/conditions/repeater-row.js");
...
/***/ "../assets/dev/js/editor/components/document-conditions/conditions/repeater-row.js":
/*!*****************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/conditions/repeater-row.js ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/***/ "../assets/dev/js/editor/components/document-conditions/conditions/views/layout.js":
/*!*****************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/conditions/views/layout.js ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/***/ "../assets/dev/js/editor/components/document-conditions/conditions/views/view.js":
/*!***************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/conditions/views/view.js ***!
  \***************************************************************************************/
/*! no static exports found */
...
var inlineControlsStack = __webpack_require__(/*! ../../inline-controls-stack.js */ "../assets/dev/js/editor/components/document-conditions/inline-controls-stack.js");
...
/***/ "../assets/dev/js/editor/components/document-conditions/inline-controls-stack.js":
/*!***************************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/inline-controls-stack.js ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "../assets/dev/js/editor/components/document-conditions/manager.js":
/*!*************************************************************************!*\
  !*** ../assets/dev/js/editor/components/document-conditions/manager.js ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = Module.extend({
  onInit: function onInit() {
    ...
    if (this.hasDocumentConditions()) {
      this.config = qazana.config.documentConditions;
      qazana.addControlView('Conditions_repeater', __webpack_require__(/*! ./conditions/repeater-control */ "../assets/dev/js/editor/components/document-conditions/conditions/repeater-control.js"));
  ...
  addHeaderSaver: function addHeaderSaver(behavior) {
    behavior.saver = {
      behaviorClass: __webpack_require__(/*! ./behavior/header-saver */ "../assets/dev/js/editor/components/document-conditions/behavior/header-saver.js")
    };
    return behavior;
  },
  addFooterSaver: function addFooterSaver(behavior) {
    behavior.saver = {
      behaviorClass: __webpack_require__(/*! ./behavior/footer-saver */ "../assets/dev/js/editor/components/document-conditions/behavior/footer-saver.js")
    };
    return behavior;
  },
  ...
  initConditionsLayout: function initConditionsLayout() {
    var ConditionsLayout = __webpack_require__(/*! ./conditions/views/layout */ "../assets/dev/js/editor/components/document-conditions/conditions/views/layout.js");

    this.conditionsLayout = new ConditionsLayout();
  },
  showConditionsModal: function showConditionsModal() {
    var self = this,
        ConditionsView = __webpack_require__(/*! ./conditions/views/view */ "../assets/dev/js/editor/components/document-conditions/conditions/views/view.js");
...
/***/ "../assets/dev/js/editor/controls/query.js":
/*!*************************************************!*\
  !*** ../assets/dev/js/editor/controls/query.js ***!
  \*************************************************/
/*! no static exports found */
...
var ControlSelect2ItemView = __webpack_require__(/*! qazana-controls/select2 */ "../assets/dev/js/editor/controls/select2.js");
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _utils_heartbeat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/heartbeat */ "../assets/dev/js/editor/utils/heartbeat.js");
/* harmony import */ var _regions_navigator_navigator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./regions/navigator/navigator */ "../assets/dev/js/editor/regions/navigator/navigator.js");
/* global QazanaConfig */
...
var App = Marionette.Application.extend({
  ...
  modules: {
    ...
    controls: {
      ...
      Query: __webpack_require__(/*! qazana-controls/query */ "../assets/dev/js/editor/controls/query.js"),
  ...
  initComponents: function initComponents() {
    var EventManager = __webpack_require__(/*! qazana-utils/hooks */ "../assets/dev/js/utils/hooks.js"),
        ...
        DocumentConditions = __webpack_require__(/*! ./components/document-conditions/manager */ "../assets/dev/js/editor/components/document-conditions/manager.js");
  ...
  initPanel: function initPanel() {
    this.addRegions({
      panel: __webpack_require__(/*! qazana-regions/panel/panel */ "../assets/dev/js/editor/regions/panel/panel.js")
    });
  },
  initNavigator: function initNavigator() {
    this.addRegions({
      navigator: {
        el: '#qazana-navigator',
        regionClass: _regions_navigator_navigator__WEBPACK_IMPORTED_MODULE_1__["default"]
      }
    });
  },
  ...
  onFirstPreviewLoaded: function onFirstPreviewLoaded() {
    this.initPanel();
    this.heartbeat = new _utils_heartbeat__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
BaseElementView = BaseContainer.extend({
  ...
  pasteStyle: function pasteStyle() {
    ...
    jQuery.each(controls, function (controlName, control) {
      ...
      if ('object' === _typeof(sourceValue)) {
        if ('object' !== _typeof(targetValue)) {
          return;
        }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _views_add_section_inline__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../views/add-section/inline */ "../assets/dev/js/editor/views/add-section/inline.js");
var BaseElementView = __webpack_require__(/*! qazana-elements/views/base */ "../assets/dev/js/editor/elements/views/base.js"),
    SectionView;
...
SectionView = BaseElementView.extend({
  ...
  onAddButtonClick: function onAddButtonClick() {
    ...
    var myIndex = this.model.collection.indexOf(this.model),
        addSectionView = new _views_add_section_inline__WEBPACK_IMPORTED_MODULE_0__["default"]({
      at: myIndex
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _default; });
/* harmony import */ var _element_empty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./element-empty */ "../assets/dev/js/editor/regions/navigator/element-empty.js");
/* harmony import */ var _root_empty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./root-empty */ "../assets/dev/js/editor/regions/navigator/root-empty.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Marionette$Composite) {
  ...
  _createClass(_default, [{
    ...
    value: function getEmptyView() {
      if (this.isRoot()) {
        return _root_empty__WEBPACK_IMPORTED_MODULE_1__["default"];
      }

      if (this.hasChildren()) {
        return _element_empty__WEBPACK_IMPORTED_MODULE_0__["default"];
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _default; });
/* harmony import */ var _element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./element */ "../assets/dev/js/editor/regions/navigator/element.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Marionette$LayoutVie) {
  ...
  _createClass(_default, [{
    ...
    value: function onShow() {
      this.elements.show(new _element__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _default; });
/* harmony import */ var _layout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./layout */ "../assets/dev/js/editor/regions/navigator/layout.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_BaseRegion) {
  ...
  function _default(options) {
    ...
    _this.opened = false;
    _this.ensurePosition = _this.ensurePosition.bind(_assertThisInitialized(_this));
  ...
  _createClass(_default, [{
    ...
    value: function beforeFirstOpen() {
      this.show(new _layout__WEBPACK_IMPORTED_MODULE_0__["default"]());
...
PanelLayoutView = Marionette.LayoutView.extend({
  ...
  onBeforeShow: function onBeforeShow() {
    var PanelFooterItemView = __webpack_require__(/*! qazana-regions/panel/footer */ "../assets/dev/js/editor/regions/panel/footer.js"),
        PanelHeaderItemView = __webpack_require__(/*! qazana-regions/panel/header */ "../assets/dev/js/editor/regions/panel/header.js"); // Edit Mode
...
helpers = {
  ...
  isActiveControl: function isActiveControl(controlModel, values) {
    ...
    var hasFields = _.filter(condition, function (conditionValue, conditionName) {
      ...
      if (conditionSubKey && 'object' === _typeof(controlValue)) {
...
function (_Marionette$ItemView) {
  ...
  function AddSectionBase() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AddSectionBase).apply(this, arguments));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (AddSectionBase);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ "../assets/dev/js/editor/views/add-section/base.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_BaseAddSectionView) {
  ...
  function AddSectionView() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AddSectionView).apply(this, arguments));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (AddSectionView);
...
function (_BaseAddSectionView) {
  ...
  _createClass(AddSectionView, [{
    key: "className",
    value: function className() {
      return _get(_getPrototypeOf(AddSectionView.prototype), "className", this).call(this) + ' qazana-add-section-inline';
    }
  }, {
    key: "fadeToDeath",
    ...
    key: "paste",
    value: function paste() {
      _get(_getPrototypeOf(AddSectionView.prototype), "paste", this).call(this);
    ...
    key: "onPresetSelected",
    value: function onPresetSelected(event) {
      _get(_getPrototypeOf(AddSectionView.prototype), "onPresetSelected", this).call(this, event);
    ...
    key: "onAddTemplateButtonClick",
    value: function onAddTemplateButtonClick() {
      _get(_getPrototypeOf(AddSectionView.prototype), "onAddTemplateButtonClick", this).call(this);
    ...
    key: "onDropping",
    value: function onDropping() {
      _get(_getPrototypeOf(AddSectionView.prototype), "onDropping", this).call(this);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _add_section_independent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-section/independent */ "../assets/dev/js/editor/views/add-section/independent.js");
...
Preview = BaseSectionsContainerView.extend({
  ...
  onRender: function onRender() {
    ...
    var addNewSectionView = new _add_section_independent__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
module.exports = Marionette.Behavior.extend({
  ...
  restore: function restore(historyItem, isRedo) {
    ...
    var BaseElementView = __webpack_require__(/*! qazana-elements/views/base */ "../assets/dev/js/editor/elements/views/base.js"); // Find the new behavior and work with him.
...
__webpack_require__(/*! /Users/frank/Sites/global-content/plugins/qazana/assets/dev/js/editor/utils/jquery-serialize-object.js */"../assets/dev/js/editor/utils/jquery-serialize-object.js");
__webpack_require__(/*! /Users/frank/Sites/global-content/plugins/qazana/assets/dev/js/editor/utils/jquery-html5-dnd.js */"../assets/dev/js/editor/utils/jquery-html5-dnd.js");
module.exports = __webpack_require__(/*! /Users/frank/Sites/global-content/plugins/qazana/assets/dev/js/editor/editor.js */"../assets/dev/js/editor/editor.js");
