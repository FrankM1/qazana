...
(function ($) {
  ...
  var QazanaGutenbergApp = {
    ...
    toggleStatus: function toggleStatus() {
      jQuery('body').toggleClass('qazana-editor-active', this.isQazanaMode).toggleClass('qazana-editor-inactive', !this.isQazanaMode);
    },
    init: function init() {
      var self = this;
      setTimeout(function () {
