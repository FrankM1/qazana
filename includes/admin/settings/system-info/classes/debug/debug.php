<?php
namespace Qazana\Admin\System\Info\Classes;

use Qazana\Admin\System\Info\Main;
 ...
 * Qazana debug.
 *
 * Qazana debug handler class is responsible for logging errors and
...
class Debug {
	 ...
	 */
	const OPTION_NAME = 'qazana_debug_log';
	 ...
	 * Debug log.
	 *
	 * Log Qazana errors and save them in the database.
	 *
	 * Fired by `wp_ajax_qazana_debug_log` action.
	 *
	 * @since 1.4.0
	 * @access public
	 */
	 ...
	 * Debug constructor.
	 *
	 * Initializing Qazana debug and logging errors.
	 *
	 * @since 1.4.0
	 * @access public
	 */
	public function __construct() {
		add_action( 'wp_ajax_qazana_debug_log', [ $this, 'debug_log' ] );
