...
/**
 * Qazana images manager.
 *
 * Qazana images manager handler class is responsible for retrieving image
 * details.
 *
 * @since 1.0.0
 */
class Images_Manager {
	 ...
	 *
	 * Fired by `wp_ajax_qazana_get_images_details` action.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 *
	 * Fired by `wp_ajax_qazana_get_image_details` action.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Initializing Qazana images manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
