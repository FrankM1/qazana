...
/**
 * Qazana WordPress widgets manager.
 *
 * Qazana WordPress widgets manager handler class is responsible for
...
class WordPress_Widgets_Manager {
	 ...
	 *
	 * Initializing the WordPress widgets manager in Qazana editor.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	public function __construct() {
		...
		add_action( 'qazana/editor/before_enqueue_scripts', [ $this, 'before_enqueue_scripts' ] );
		add_action( 'qazana/editor/footer', [ $this, 'footer' ] );
	}

	/**
	 * Before enqueue scripts.
	 *
	 * Prints custom scripts required to run WordPress widgets in Qazana
	 * editor.
	 *
	 * Fired by `qazana/editor/before_enqueue_scripts` action.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	 ...
	 *
	 * Prints WordPress widgets scripts in Qazana editor footer.
	 *
	 * Fired by `qazana/editor/footer` action.
	 *
	 * @since 1.5.0
	 * @access public
	 */
