...
/**
 * Qazana template library source base.
 *
 * Qazana template library source base handler class is responsible for
 * initializing all the methods controlling the source of Qazana templates.
 *
 * @since 1.0.0
 * @abstract
 */
abstract class Source_Base {
	 ...
	 *
	 * Retrieve Qazana meta data for the current user.
	 *
	 * @since 1.9.0
	 * @access public
	 *
	 ...
	 *
	 * For any given Qazana content/data, replace the IDs with new randomly
	 * generated IDs.
	 *
	 * @since 1.0.0
	 * @access protected
	 *
	 * @param array $content Any type of Qazana data.
	 *
	...
	/**
	 * Get Qazana library user meta prefix.
	 *
	 * Retrieve user meta prefix used to save Qazana data.
	 *
	 * @since 1.9.0
	 * @access protected
	 *
	...
	protected function get_user_meta_prefix() {
		return 'qazana_library_' . $this->get_id();
	}
