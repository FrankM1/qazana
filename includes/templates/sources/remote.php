...
/**
 * Qazana template library remote source.
 *
 * Qazana template library remote source handler class is responsible for
 * handling remote templates from Qazana.net servers.
 *
 * @since 1.0.0
 */
class Source_Remote extends Source_Base {
	 ...
	 *
	 * Retrieve remote templates from Qazana.net servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 * Get remote template.
	 *
	 * Retrieve a single remote template from Qazana.net servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Remote template from Qazana.net servers cannot be saved on the
	 ...
	 *
	 * Remote template from Qazana.net servers cannot be updated on the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Remote template from Qazana.net servers cannot be deleted from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Remote template from Qazana.net servers cannot be exported from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Retrieve the data of a single remote template from Qazana.net servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
