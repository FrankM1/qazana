<?php
namespace Qazana\Core\Settings;
...
/**
 * Qazana settings manager.
 *
 * Qazana settings manager handler class is responsible for registering and
 * managing Qazana settings managers.
 *
 * @since 1.6.0
 */
class Manager {
	 ...
	 *
	 * Holds the names for builtin Qazana settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 *
	 ...
	 *
	 * Register builtin Qazana settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
