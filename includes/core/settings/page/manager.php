...
/**
 * Qazana page settings manager.
 *
 * Qazana page settings manager handler class is responsible for registering
 * and managing Qazana page settings managers.
 *
 * @since 1.6.0
 */
class Manager extends BaseManager {
	...
	public static function get_page( $id ) {
		// translators: %s Qazana Document Settings API URL
		_deprecated_file( __METHOD__, '1.6.0', __( 'the new settings API', 'qazana' ), sprintf( __( 'See <a href="%s">Qazana Document Settings</a> for more information.', 'qazana' ), 'https://developers.qazana.net/qazana-document-settings/' ) );
	...
	public function add_page_settings_css( $post_css ) {
		...
		// Add a css comment
		$custom_css = '/* Start custom CSS for Qazana page-settings */' . $custom_css . '/* End custom CSS */';
