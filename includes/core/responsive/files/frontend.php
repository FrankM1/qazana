...
class Frontend extends Base {
	...
	const META_KEY = 'qazana-custom-breakpoints-files';
	...
	public function parse_content() {
		...
		$file_content = preg_replace_callback( '/QAZANA_SCREEN_([A-Z]+)_([A-Z]+)/', function ( $placeholder_data ) use ( $breakpoints_keys, $breakpoints ) {
