<?php
namespace Qazana\Core\Responsive;
 ...
 * Qazana responsive.
 *
 * Qazana responsive handler class is responsible for setting up Qazana
...
class Breakpoints {
	...
	public static function get_stylesheet_templates_path() {
		return QAZANA_ASSETS_PATH . 'css/templates/';
	}
	...
	private static function get_stylesheet_templates() {
		...
		return apply_filters( 'qazana/core/responsive/get_stylesheet_templates', $templates );
	}
}
