<?php
namespace Qazana\Core\DynamicTags;
...
class Manager {
	 ...
	 *
	 * Initializing Qazana dynamic tags manager.
	 *
	 * @since 2.0.0
	 * @access public
	 */
	...
	public function get_tags() {
		if ( ! did_action( 'qazana/dynamic_tags/register_tags' ) ) {
			/**
			 * Register dynamic tags.
			 *
			 * Fires when Qazana registers dynamic tags.
			 *
			 * @since 2.0.9
			 *
			 * @param Manager $this Dynamic tags manager.
			 */
			do_action( 'qazana/dynamic_tags/register_tags', $this );
		}
	...
	public function ajax_render_tags() {
		 ...
		 *
		 * Fires before Qazana renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
		do_action( 'qazana/dynamic_tags/before_render' );
		 ...
		 *
		 * Fires after Qazana renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
	...
	private function add_actions() {
		add_action( 'wp_ajax_qazana_render_tags', [ $this, 'ajax_render_tags' ] );
		add_action( 'qazana/css-file/post/enqueue', [ $this, 'after_enqueue_post_css' ] );
	}
}
