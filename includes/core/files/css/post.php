...
/**
 * Qazana post CSS file.
 *
 * Qazana CSS file handler class is responsible for generating the single
 * post CSS file.
 *
 * @since 1.2.0
 */
class Post extends Base {
	 ...
	 * Enqueue CSS.
	 *
	 * Enqueue the post CSS file in Qazana.
	 *
	 * This method ensures that the post was actually built with qazana before
