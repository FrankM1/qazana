...
use Qazana\Extensions\Assets_Manager\AssetTypes\Fonts_Manager;
...
class Custom_Fonts extends Classes\Font_Base {
	...
	public function add_meta_box() {
		add_meta_box(
			...
			__( 'Manage Your Font Files', 'qazana' ),
			[ $this, 'render_metabox' ],
			Fonts_Manager::CPT,
			'normal',
			'default'
	...
	public function render_metabox( $post ) {
		...
		$repeater = [
			...
			'id' => 'font_face',
			'label' => false,
			'add_label' => __( 'Add Font Variation', 'qazana' ),
	...
	public function handle_panel_request() {
		...
		if ( empty( $font_face ) ) {
			...
			$error_message = sprintf( __( 'Font %s was not found.', 'qazana' ), $font_family );
	...
	private function get_file_type_description( $file_type ) {
		$descriptions = [
			...
			'woff2' => __( 'The Web Open Font Format 2, Used by Super Modern Browsers', 'qazana' ),
			'woff' => __( 'The Web Open Font Format, Used by Modern Browsers', 'qazana' ),
			'ttf' => __( 'TrueType Fonts, Used for better supporting Safari, Android, iOS', 'qazana' ),
