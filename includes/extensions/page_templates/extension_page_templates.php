...
/**
 * Qazana page templates module.
 *
 * Qazana page templates module handler class is responsible for registering
 * and managing Qazana page templates modules.
 *
 * @since 2.0.0
 */
class Page_Templates extends Base {

	/**
	 * Qazana Canvas template name.
	 */
	const TEMPLATE_CANVAS = 'qazana_canvas';

	/**
	 * Qazana Header & Footer template name.
	 */
	const TEMPLATE_HEADER_FOOTER = 'qazana_header_footer';
	 ...
	 * Template include.
	 *
	 * Update the path for the Qazana Canvas template.
	 *
	 ...
	 *
	 * Adds Qazana templates to all the post types that support
	 * Qazana.
	 *
	 ...
	 * Add page templates.
	 *
	 * Add the Qazana page templates to the theme templates.
	 *
	...
	public function add_page_templates( $page_templates, $wp_theme, $post ) {
		...
		$page_templates = [
			self::TEMPLATE_CANVAS => _x( 'Qazana Canvas', 'Page Template', 'qazana' ),
			self::TEMPLATE_HEADER_FOOTER => _x( 'Qazana Full Width', 'Page Template', 'qazana' ),
		] + $page_templates;
	 ...
	 *
	 * Qazana don't allow WordPress to update the parent page template
	 ...
	 *
	 * Initializing Qazana page templates module.
	 *
	 * @since 2.0.0
	 * @access public
	 */
	public function __construct() {
		...
		add_action( 'qazana/documents/register_controls', [ $this, 'action_register_template_control' ] );
