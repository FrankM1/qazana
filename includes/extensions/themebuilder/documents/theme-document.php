...
use Qazana\Extensions\Library\Documents\Library_Document;
...
abstract class Theme_Document extends Library_Document {
	...
	public function print_content() {
		...
		if ( qazana()->preview->is_preview_mode( $this->get_main_id() ) ) {
			echo qazana()->preview->builder_wrapper( '' );
		} else {
