...
class Search_Form extends Theme_Elements_Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'minimal' => __( 'Minimal', 'qazana' ),
					'full_screen' => __( 'Full Screen', 'qazana' ),
				],
		...
		$this->add_control(
			'placeholder',
			[
				'label' => __( 'Placeholder', 'qazana' ),
				'type' => Controls_Manager::TEXT,
				'separator' => 'before',
				'default' => __( 'Search', 'qazana' ) . '...',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'search' => [
						'title' => __( 'Search', 'qazana' ),
						'icon' => 'fa fa-search',
					],
					'arrow' => [
						'title' => __( 'Arrow', 'qazana' ),
		...
		<form class="elementor-search-form" role="search" action="<?php echo home_url(); ?>" method="get">
			...
			<div class="elementor-search-form__container">
				...
				<div class="dialog-lightbox-close-button dialog-close-button">
					...
					<span class="elementor-screen-only"><?php esc_html_e( 'Close', 'qazana' ); ?></span>
				</div>
				<?php endif ?>
			</div>
		</form>
	...
	protected function _content_template() {
		...
		<form class="elementor-search-form" action="" role="search">
			...
			<div class="elementor-search-form__container">
				...
				<input type="search"
				       name="s"
				       title="<?php esc_attr_e( 'Search', 'qazana' ); ?>"
				       class="elementor-search-form__input"
				       placeholder="{{ settings.placeholder }}">
