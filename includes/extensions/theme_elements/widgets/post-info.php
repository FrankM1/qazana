...
class Post_Info extends Theme_Elements_Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'date' => __( 'Date', 'qazana' ),
					'time' => __( 'Time', 'qazana' ),
					'comments' => __( 'Comments', 'qazana' ),
					'terms' => __( 'Terms', 'qazana' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					'default' => 'Default',
					'0' => _x( 'March 6, 2018 (F j, Y)', 'Date Format', 'qazana' ),
					'1' => '2018-03-06 (Y-m-d)',
					'2' => '03/06/2018 (m/d/Y)',
					'3' => '06/03/2018 (d/m/Y)',
		...
		$repeater->add_control(
			'custom_date_format',
			[
				'label' => __( 'Custom Date Format', 'qazana' ),
		...
		$repeater->add_control(
			'custom_time_format',
			[
				'label' => __( 'Custom Time Format', 'qazana' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'g:i a',
				'placeholder' => 'g:i a',
				'label_block' => false,
		...
		$repeater->add_control(
			'string_no_comments',
			[
				'label' => __( 'No Comments', 'qazana' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'placeholder' => __( 'No Comments', 'qazana' ),
				'condition' => [
		...
		$repeater->add_control(
			'string_one_comment',
			[
				'label' => __( 'One Comment', 'qazana' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'placeholder' => __( 'One Comment', 'qazana' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'placeholder' => __( '%s Comments', 'qazana' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
	...
	protected function get_meta_data( $repeater_item ) {
		...
		switch ( $repeater_item['type'] ) {
			...
			case 'comments':
				if ( comments_open() ) {
					$default_strings = [
						'string_no_comments' => __( 'No Comments', 'qazana' ),
						'string_one_comment' => __( 'One Comment', 'qazana' ),
						'string_comments' => __( '%s Comments', 'qazana' ),
					];
					...
					if ( 0 === $num_comments ) {
						...
						$item_data['text'] = sprintf( _n( $default_strings['string_one_comment'], $default_strings['string_comments'], $num_comments, 'qazana' ), $num_comments );
					}
