...
class Shared_Carousel_Controls {

    /**
     * Sections Injection point
     *
     * @var string section name
     */
    public $injection_point = 'section_carousel_settings';

    public function __construct() {
        add_action( 'qazana/element/after_section_start', [ $this, 'carousel_settings' ], 10, 3 );
        add_action( 'qazana/element/after_section_end', [ $this, 'style_arrows_navigation' ], 10, 3 );
        add_action( 'qazana/element/after_section_end', [ $this, 'style_bullets_navigation' ], 10, 3 );
    }
     ...
     */
    function carousel_settings( $element, $section_id, $args ) {

        $required_section_id = '';

        if ( $element instanceof Widget_Base ) {
			$required_section_id = $this->injection_point;
		}

		if (  empty( $element->carousel ) || ! $element->carousel || $required_section_id !== $section_id ) {
			return;
		}
     ...
     * @param array          $args       Section arguments.
     */
    function style_arrows_navigation( $element, $section_id, $args ) {
     ...
     * @param array          $args       Section arguments.
     */
    function style_bullets_navigation( $element, $section_id, $args ) {
