...
class Widget_Tooltip extends Widget_Base {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .qazana-tooltip__content:after' => 'border-top-color: {{VALUE}};',
	...
	protected function _content_template() {
		...
		<div class="qazana-tooltip v--{{{ settings.tooltip_state }}}">
			...
			<div class="qazana-tooltip__content v--{{{ settings.tooltip_position }}}">{{ settings.tooltip_editor }}</div>
		</div>
		<?php
	}
}
