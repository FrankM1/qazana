...
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			 ...
			 * Font groups.
			 *
			 * Filters the fonts groups used by Qazana.
			 *
			 * @since 1.9.4
			 *
			 * @param array $font_groups Font groups.
			 */
			$font_groups = apply_filters( 'qazana/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$additional_fonts ) {
			 ...
			 * Additional fonts.
			 *
			 * Filters the fonts used by Qazana to add additional fonts.
			 *
			 * @since 1.9.4
			 *
			 * @param array $additional_fonts Additional Qazana fonts.
			 */
			$additional_fonts = apply_filters( 'qazana/fonts/additional_fonts', $additional_fonts );
