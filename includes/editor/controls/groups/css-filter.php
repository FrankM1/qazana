...
class Group_Control_Css_Filter extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['blur'] = [
			'label' => _x( 'Blur', 'Filter Control', 'qazana' ),
		...
		$controls['brightness'] = [
			'label' => _x( 'Brightness', 'Filter Control', 'qazana' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
		...
		$controls['contrast'] = [
			'label' => _x( 'Contrast', 'Filter Control', 'qazana' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
		...
		$controls['saturate'] = [
			'label' => _x( 'Saturation', 'Filter Control', 'qazana' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
		...
		$controls['hue'] = [
			'label' => _x( 'Hue', 'Filter Control', 'qazana' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'CSS Filters', 'Filter Control', 'qazana' ),
			],
		];
	}
}
