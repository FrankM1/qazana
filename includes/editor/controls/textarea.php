	...
	public function content_template() {
		...
		<div class="qazana-control-field">
			...
			<div class="qazana-control-input-wrapper">
				<textarea id="<?php echo $control_uid; ?>" class="qazana-control-tag-area" rows="{{ data.rows }}" data-setting="{{ data.name }}" placeholder="{{ data.placeholder }}"></textarea>
			</div>
		</div>
		<# if ( data.description ) { #>
