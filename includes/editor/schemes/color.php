 ...
 * Qazana color scheme.
 *
 * Qazana color scheme class is responsible for initializing a scheme for
 * colors.
 *
 * @since 1.0.0
 */
		...
		<div class="qazana-panel-scheme-colors-more-palettes qazana-panel-box">
			...
			<div class="qazana-panel-box-content">
				<?php foreach ( $this->_get_system_schemes_to_print() as $scheme_name => $scheme ) : ?>
					<div class="qazana-panel-scheme-color-system-scheme" data-scheme-name="<?php echo esc_attr( $scheme_name ); ?>">
